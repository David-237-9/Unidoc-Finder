...
async function crawlRepository(repository, documentStream) {
    ...
    console.log(`Finished ${repository.name}. Processed: ${processed}; kept: ${kept}; total kept: ${documentCount}; sent: ${sentDocumentsCount}`);
}
...
function printProgress(page, processed, kept) {
    console.log(`  Page ${page}; processed: ${processed}; kept: ${kept}; total kept: ${documentCount}; total sent: ${sentDocumentsCount}`)
}
